         ...
         <div className="w-full" style ={{paddingLeft: `${leftVal * 10}px` }}>
          ...
          <p className="font-gelasio text-xl ml-3">{comment}</p>
                <div className="flex gap-5 item-center mt-5">
                    {
                        commentData.isReplyLoaded ? <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2  " onClick={hideReplies}>
                            <i className="fi fi-rs-comment-dots"></i>
                            Hide
                        </button> : <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2  " onClick={loadReplies}>
                            <i className="fi fi-rs-comment-dots"></i>
                ...
                {
                    username == commented_by_username || username == blog_author ? <button className=" p-2 p-3 rounded-md border border-grey ml-auto hover:bg-red/30 hover:text-red items-center" onClick={deleteComment}>
