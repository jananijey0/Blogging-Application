...
let categories = ["Programming","Hollywood","Social Media","Tech","Finances","Travel","Web Development","Music"]
...
categories.map((category,i) => {
    return( 
    <button onClick={loadBlogByCategory}    
...
<div><h1 className='font-medium text-xl mb-8 '>Trending <i className='fi fi-rr-arrow-trend-up'></i></h1>
{
    trendingBlogs == null ? <Loader/> :  trendingBlogs.length ?
    trendingBlogs.map((blog,i)=>{
     return ( <AnimationWrapper key ={i} transition={{duration:1, delay:i*.1}}>
